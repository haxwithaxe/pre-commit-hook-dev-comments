...
//   comment.
char *foo;    // DEBUG: block comment after stuff. M4.0 // random note for future devs

// SAMPLE M4.1: Added junk before the beginning and after the end of the one-line block
//   comment.
char *foo;    /* DEBUG: block comment after stuff. M4.1 */ // random note for future devs
...
/* DEBUG: opened but not closed inline block-syntax comment S(-1)
