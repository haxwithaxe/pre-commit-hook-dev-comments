...
/* This should match the debug block comment regex
 *
 * FIXME: mid-block comment
 *
 */

// SAMPLE M2: A one-line block syntax comment with the trigger word at the
//   beginning.
/* FIXME: one-line block comment. This should match the debug block comment regex */
...
//   comment.
char *foo;    /* FIXME: block comment after stuff. M4 */ # random note for future devs


// SAMPLE M5: Added junk before the beginning of the multi-line block
//   comment.
char *bar;  /* FIXME: Stuff before a block comment shouldn't matter.
...
// FIXME: multiple inline comments
//
...
// This should *NOT* match the debug block comment regex
/* FIXME: opened but not closed block comment
