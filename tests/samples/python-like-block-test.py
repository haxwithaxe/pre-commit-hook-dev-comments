...
TEST: mid-block comment. Double quotes.
	<Tab here M1.0
"""
...
# v Tab here
	""" TEST: Block comment with a tab before. M3.1 """


# SAMPLE M4: Added junk before the beginning and after the end of the one-line block
#   comment.
def foo() -> None:    """ TEST: block comment after stuff. M4 """ # random note for future devs
    pass

# SAMPLE M5: Added junk before the beginning of the multi-line block
#   comment.
SOME_VAR = 42  """ TEST: Stuff before a block comment shouldn't matter.
...
"""fooTEST: This should not match. S2"""
...
''' TEST: opened but not closed block comment S(-1)
