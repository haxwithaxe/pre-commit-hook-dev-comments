...
"""{trigger_upper}: nominal block comment
...
{trigger_upper}: mid-block comment. Double quotes.
	<Tab here M1.0
"""
...
# v Tab here
	""" {trigger_upper}: Block comment with a tab before. M3.1 """


# SAMPLE M4: Added junk before the beginning and after the end of the one-line block
#   comment.
def foo() -> None:    """ {trigger_upper}: block comment after stuff. M4 """ # random note for future devs
    pass

# SAMPLE M5: Added junk before the beginning of the multi-line block
#   comment.
SOME_VAR = 42  """ {trigger_upper}: Stuff before a block comment shouldn't matter.
