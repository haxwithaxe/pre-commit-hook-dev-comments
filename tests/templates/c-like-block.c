...
/* This should match the debug block comment regex
 *
 * {trigger_upper}: mid-block comment
 *
 */

// SAMPLE M2: A one-line block syntax comment with the trigger word at the
//   beginning.
/* {trigger_upper}: one-line block comment. This should match the debug block comment regex */
...
//   comment.
char *foo;    /* {trigger_upper}: block comment after stuff. M4 */ # random note for future devs


// SAMPLE M5: Added junk before the beginning of the multi-line block
//   comment.
char *bar;  /* {trigger_upper}: Stuff before a block comment shouldn't matter.
...
// {trigger_upper}: multiple inline comments
//
...
// This should *NOT* match the debug block comment regex
/* {trigger_upper}: opened but not closed block comment
