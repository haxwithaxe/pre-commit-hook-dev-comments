...
'''TEST: nominal inline comment M0.2'''
...
#   comment. 4 leading spaces.
# vv Spaces here
    ''' TEST: one-line block comment. M3.2 '''


# SAMPLE M4.0: Added junk before the beginning and after the end of the
#   inline comment.
def foo() -> None:    # TEST: block comment after stuff. M4.0 # random note for future devs
    pass

# SAMPLE M4.1: Added junk before the beginning and after the end of the
#   one-line block comment.
def foo() -> None:    """ TEST: block comment after stuff. M4.1 """ # random note for future devs
    pass

# SAMPLE M4.2: Added junk before the beginning and after the end of the
#   one-line block comment.
def foo() -> None:    ''' TEST: block comment after stuff. M4.2 ''' # random note for future devs
    pass
...
#   Mixed tabs and spaces.
#     vv Tab here
   ''' 	  TEST: Random whitespaces before trigger text. M6.2'''
#^^Here ^^ Spaces here
