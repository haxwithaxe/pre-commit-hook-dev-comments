...
#   comment. 4 leading spaces.
# vv Spaces here
    """ DEBUG: one-line block comment. M3.1 """

# SAMPLE M3.2: Added space around the beginning and end of the inline
#   comment. 4 leading spaces.
# vv Spaces here
    ''' DEBUG: one-line block comment. M3.2 '''


# SAMPLE M4.0: Added junk before the beginning and after the end of the
#   inline comment.
def foo() -> None:    # DEBUG: block comment after stuff. M4.0 # random note for future devs
    pass

# SAMPLE M4.1: Added junk before the beginning and after the end of the
#   one-line block comment.
def foo() -> None:    """ DEBUG: block comment after stuff. M4.1 """ # random note for future devs
    pass

# SAMPLE M4.2: Added junk before the beginning and after the end of the
#   one-line block comment.
def foo() -> None:    ''' DEBUG: block comment after stuff. M4.2 ''' # random note for future devs
    pass
...
""" Some helpful text
DEBUG: Multiple inline comments S0.0
"""

# SAMPLE S0.1: This is an multi-line block comment not an inline comment.
''' Some helpful text
DEBUG: Multiple inline comments S0.1
'''
