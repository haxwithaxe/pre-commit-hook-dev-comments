...
/* This should match the debug block comment regex
 *
 * TEST: mid-block comment
 *
 */

// SAMPLE M2: A one-line block syntax comment with the trigger word at the
//   beginning.
/* TEST: one-line block comment. This should match the debug block comment regex */
...
//   comment.
char *foo;    /* TEST: block comment after stuff. M4 */ # random note for future devs


// SAMPLE M5: Added junk before the beginning of the multi-line block
//   comment.
char *bar;  /* TEST: Stuff before a block comment shouldn't matter.
...
// This should *NOT* match the debug block comment regex
/* TEST: opened but not closed block comment
